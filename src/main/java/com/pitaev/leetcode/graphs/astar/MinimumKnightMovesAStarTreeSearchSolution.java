...
/**
 * A* Tree search solution of the leetcode problem<code>1197</code>:
 ...
 *     <li>Don't store visited information as it will take large amount of memory on the infinite grid</li>
 * </ul>
 */
class MinimumKnighMovesAStarTreeSearch {
